...
class AssertSubscriberTest {
    ...
    // Since we have added `1` when creating AssertSubscriber, it would fail at awaitCompletion because the multi
    // wouldn't have completed as it has 1 more item
    @Test
    @Disabled
