...
public class Main {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        objectMapper1.registerModule(
                new JSR310Module()); // Java 8 date/time type `java.time.LocalDateTime` not supported by default: so
        // added JSR310Module module to enable handling
        ...
        String expectedJson2 =
                "{\"date\":{\"year\":2021,\"month\":12,\"day\":13},\"time\":{\"hour\":9,\"minute\":15,\"second\":53,\"nano\":810000000}}";
