...
public class SomeService {
    ...
    // It means the update method gets called, but the inner Uni never executes, preventing the `Item retrieved from DB` log from appearing.
    ...
    // someRepo.update() returns Uni<String> and we are using TransformToUni. So, the effective result would be Uni<String>
    // It means the update method gets called, and the inner Uni executes as well, generating the `Item retrieved from DB` log.
